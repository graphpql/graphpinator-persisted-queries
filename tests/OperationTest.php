    ...
    public function simpleDataProvider() : array
    {
        return [
            ...
            [
                ...
                1589897943,
                '[{"type":"query","name":"queryName","fieldSet":[{"fieldName":"field","alias":"field","argumentValueSet":[],"directiveSet":[],"fieldSet":[{"fieldName":"scalar","alias":"scalar","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null}],"typeCond":null}],"variableSet":[],"directiveSet":[]},{"type":"query","name":"queryName2","fieldSet":[{"fieldName":"field2","alias":"field2","argumentValueSet":[],"directiveSet":[],"fieldSet":[{"fieldName":"field","alias":"field","argumentValueSet":[],"directiveSet":[],"fieldSet":[{"fieldName":"fieldArg","alias":"fieldArg","argumentValueSet":[{"argument":"arg1","value":{"valueType":"Graphpinator\\\Value\\\ScalarValue","type":{"type":"named","name":"Int"},"value":123}}],"directiveSet":[],"fieldSet":null,"typeCond":null}],"typeCond":null}],"typeCond":null}],"variableSet":[],"directiveSet":[]}]',
                \Infinityloop\Utils\Json::fromNative((object) ['data' => ['field' => ['scalar' => 987]]]),
            ],
            [
                Json::fromNative((object) [
                    'query' => 'query queryName { field { scalar } } mutation mutationName { mutationField, secondField: mutationField, thirdField: mutationField }',
                ]),
                2364436310,
                '[{"type":"query","name":"queryName","fieldSet":[{"fieldName":"field","alias":"field","argumentValueSet":[],"directiveSet":[],"fieldSet":[{"fieldName":"scalar","alias":"scalar","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null}],"typeCond":null}],"variableSet":[],"directiveSet":[]},{"type":"mutation","name":"mutationName","fieldSet":[{"fieldName":"mutationField","alias":"mutationField","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null},{"fieldName":"mutationField","alias":"secondField","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null},{"fieldName":"mutationField","alias":"thirdField","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null}],"variableSet":[],"directiveSet":[]}]',
                \Infinityloop\Utils\Json::fromNative((object) ['data' => ['field' => ['scalar' => 987]]]),
            ],
            [
                Json::fromNative((object) [
                ...
                1309780448,
                '[{"type":"query","name":"queryName","fieldSet":[{"fieldName":"field","alias":"field","argumentValueSet":[],"directiveSet":[],"fieldSet":[{"fieldName":"scalar","alias":"scalar","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null}],"typeCond":null}],"variableSet":[],"directiveSet":[]},{"type":"mutation","name":"mutationName","fieldSet":[{"fieldName":"mutationField","alias":"mutationField","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null},{"fieldName":"mutationField","alias":"secondField","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null},{"fieldName":"mutationField","alias":"thirdField","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null}],"variableSet":[],"directiveSet":[]},{"type":"subscription","name":"subscriptionName","fieldSet":[{"fieldName":"subscriptionField","alias":"subscriptionField","argumentValueSet":[],"directiveSet":[],"fieldSet":null,"typeCond":null}],"variableSet":[],"directiveSet":[]}]',
                \Infinityloop\Utils\Json::fromNative((object) ['data' => ['field' => ['scalar' => 987]]]),
            ]
        ];
    }
